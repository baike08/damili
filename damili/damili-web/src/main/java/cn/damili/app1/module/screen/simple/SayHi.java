...
package cn.damili.app1.module.screen.simple;
...
import cn.damili.dal.dao.impl.NlbLoginDAOImpl;
 ...
 * @author Michael Zhou
 */
public class SayHi extends BaseScreen {

    @Autowired
    private NlbLoginDAOImpl nlbLoginDAO;
	...
	protected String frontExecute(ParameterParser paramParser, Context context,
        ...
        out.println(nlbLoginDAO.login("laiweibin08", "abcd", 0));
